...
import modelos.ModeloGeneticoEj5;
import modelos.ModeloPLEEj1;
import modelos.ModeloPLEEj3;
import modelos.ModeloPLEEj5;
...
public class TestAGEj5 {

	public static void main(String[] args) throws IOException {
		String header = "PI5Ej5DatosEntrada";
		...
		for(int i = 1; i <= 3; i++) {
			var alg = AlgoritmoAG.of(ModeloGeneticoEj5.create(header, i));
			alg.ejecuta();
